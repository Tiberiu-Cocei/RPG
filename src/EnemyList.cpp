...
Enemy* EnemyList::get_enemy(int index) {
    ...
    switch(index) {
        ...
        case 35 :
            enemyStats = new EnemyStats(1535, 127, 134, 116, 105);
            consumableDrops.push_back(consumableItemList->get_consumable_item(64));
            consumableDrops.push_back(consumableItemList->get_consumable_item(64));
            consumableDrops.push_back(consumableItemList->get_consumable_item(64));
            consumableDrops.push_back(consumableItemList->get_consumable_item(64));
