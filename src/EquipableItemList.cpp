...
EquipableItem* EquipableItemList::get_equipable_item(short int index) {
    switch(index) {
        ...
        default :
            return new EquipableItem(0, 0, 0, 0, 0, 0, 0, 0, 0, "ERROR_ITEM", "ERROR_ITEM", "ERROR_ITEM");
    }
}
